...
class FornecedorForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        search_url = (
            reverse("buscar_pessoas", kwargs={"area": "administracao"}) + "?all=true"
        )
    ...
    def clean_pessoa(self):
        ...
        if pessoa:
            ...
            if hasattr(pessoa, "fornecedor") and (
                not self.instance.pk or pessoa.fornecedor.pk != self.instance.pk
            ):
